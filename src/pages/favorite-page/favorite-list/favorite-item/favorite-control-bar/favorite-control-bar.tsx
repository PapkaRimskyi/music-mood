...
function FavoriteControlBar({ isPlaying, onPlayClickHandler, onDeleteClickHandler, children }: Props) {
  const playButtonClass = classNames("w-6 h-6", !isPlaying ? "bg-play-image" : "bg-pause-image");
...
export default FavoriteControlBar;
